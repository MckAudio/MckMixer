...
LSRCS = ./src/main.cpp ./src/MckTypes.cpp ./src/MckMixer.cpp ./src/MckDelay.cpp ./src/MckRecorder.cpp ./src/MckLooper.cpp ./src/MckControl.cpp ./helper/JackHelper.cpp ./helper/DspHelper.cpp ./helper/Metronome.cpp ./helper/Transport.cpp
